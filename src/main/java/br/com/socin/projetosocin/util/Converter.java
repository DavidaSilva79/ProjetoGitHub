...
public class Converter {
	...
	public static Util fromJsonString(String json) throws IOException {
		return getObjectReader().readValue(json);
	}

	public static String toJsonString(Util obj) throws JsonProcessingException {
	...
	private static void instantiateMapper() {
		...
		reader = mapper.readerFor(Util.class);
		writer = mapper.writerFor(Util.class);
	}
